...
export const storeOAuthTokens = async (userId: string, platform: SocialPlatform, tokens: { access_token: string, refresh_token?: string }) => {
  return supabase
    ...
    .upsert({
      ...
      username: 'twitter_user' // This is a temporary placeholder; it will be updated later
    });
};
